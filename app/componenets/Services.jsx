...
const Services = () => {
  return (
    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I build reliable backend systems and clean web experiences - from development to deployment.</motion.p>
            ...
            {serviceData.map(({icon, title, description, link}, index) => (
                ...
                className='border border-gray-400 rounded-lg px-8 py-12
                 ...
                 dark:hover:bg-darkHover dark:hover:shadow-white'>
                    ...
                    <h3 className='text-lg my-4 text-gray-700 font-semibold dark:text-white'>{title}</h3>
