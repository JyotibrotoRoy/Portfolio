...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "af0dabc4-6ed4-4780-ae88-7b401808d25f");
  ...
  return (
    ...
    dark:bg-none'>
        ...
        onSubmit={onSubmit} action="" className='max-w-2xl mx-auto'>
            ...
            id="" rows='6' placeholder='Enter your message' required
            ...
            dark:border-[0.5px] dark:hover:bg-darkHover'>
                Submit now <Image src={assets.right_arrow_bold_dark} alt='' className='w-4' /></motion.button>
