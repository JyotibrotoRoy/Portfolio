...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>few things I've built - simple on the outside, solid underneath.</motion.p>
    <motion.div
    initial={{opacity:0}}
    whileInView={{opacity:1}}
        ...
        {workData.map((project, index) => (
            ...
            justify-between duration-500 group-hover:bottom-7'>
                ...
                <a
                    ...
                    className='border rounded-full border-blue w-9
    ...
    href="https://github.com/JyotibrotoRoy?tab=repositories"
    target="_blank"
    rel="noopener noreferrer"
    ...
    dark:hover:bg-darkHover'>
        Show more <Image src={isDarkMode ? assets.right_arrow_bold_dark : assets.right_arrow} alt='right_arrow' className='w-4' /></motion.a>
    </motion.div>
  )
}
